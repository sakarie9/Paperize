...
fun WallpaperScreen(
    ...
    var showChangeNowDialog by rememberSaveable { mutableStateOf(false) }
    ...
    if (showChangeNowDialog) {
        AlertDialog(
            onDismissRequest = { showChangeNowDialog = false },
            title = { Text(stringResource(R.string.change_wallpaper)) },
            text = { Text(stringResource(R.string.change_wallpaper_now_question)) },
            confirmButton = {
                TextButton(
                    onClick = {
                        showChangeNowDialog = false
            ...
            dismissButton = {
                TextButton(onClick = { showChangeNowDialog = false }) {
            ...
            if (shouldShowScreen) {
                ...
                if (shouldShowSettings) {
                    ...
                    CurrentAndNextChange(
                        lastSetTime = scheduleSettings.lastSetTime,
                        nextSetTime = scheduleSettings.nextSetTime,
                        onNextChangeClick = { showChangeNowDialog = true }
                    )
                    TimeSliders(
